      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            <li><a href="<?php echo site_url('index.php/programs'); ?>">Programs</a></li>
        ...
        <div class="site-header__util">
          ...
          <span class="search-trigger js-search-trigger" id="search"><i class="fa fa-search" aria-hidden="true"></i></span>
        </div>
      </div>
    </div>
  </header>
